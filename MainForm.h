...
__published:	// IDE-managed Components
	...
	TButton *ButtonHRV;
	TButton *ButtonENG;
	TButton *ButtonDeleteAlbum;
	TButton *ButtonDeleteAccount;
	TButton *Button1;
	TButton *Button2;
	...
	void __fastcall ButtonDeleteAlbumClick(TObject *Sender);
	void __fastcall ButtonDeleteAccountClick(TObject *Sender);
